...
window.addEventListener('DOMContentLoaded', function(){
	...
	let showBtn = document.getElementsByClassName('service_btn'),
	 	...
	 	for (let i = 0; i < showBtn.length; i++) {
	 		showBtn[i].addEventListener('click', function(){
	 			hideContent[i].classList.toggle('active_content');
	 			setTimeout(function(){
	...
	let btn = document.getElementsByClassName('btn'),
		...
		popupContent = document.querySelector('.modal-window_content'),
...
$(function(){
	$(window).scroll(function(){
		...
		// Spy menu
			let scrollMnuLocation = $(this).scrollTop();

			scrollMnu.each(function(){

				let sectionOffset = $(this.hash).offset().top;

				if (sectionOffset <= scrollMnuLocation + 220){
